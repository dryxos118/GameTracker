        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LibraryStatus = table.Column<string>(type: "TEXT", maxLength: 30, nullable: false),
                    PlayStatus = table.Column<string>(type: "TEXT", maxLength: 30, nullable: true),
                    ...
                    PlayedHours = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 0),
                    ReleaseDate = table.Column<DateOnly>(type: "TEXT", nullable: true),
                    AddedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    PlatformId = table.Column<int>(type: "INTEGER", nullable: false),
                    LauncherId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
